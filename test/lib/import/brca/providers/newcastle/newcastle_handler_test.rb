...
class NewcastleHandlerTest < ActiveSupport::TestCase
  ...
  test 'process_test_status' do
    @logger.expects(:info).with('Encountered teststatus No appropriate status')
    @handler.process_test_status(@genotype, @record)
    assert_nil @genotype.attribute_map['teststatus']
    other_record = build_raw_record('pseudo_id1' => 'bob')
    other_record.raw_fields['teststatus'] = 'nmd'
    other_record.raw_fields['gene'] = nil
    other_record.raw_fields['genotype'] = nil
    null_genotype = Import::Brca::Core::GenotypeBrca.new(other_record)
    @handler.process_test_status(null_genotype, other_record)
    assert_equal 1, null_genotype.attribute_map['teststatus']
  end
  ...
  test 'process_nmd_record_withnogene_nomutation' do
    ...
    # @handler.add_gene_info(nmd_genotype, nmd_no_mutationrecord)
    ...
    @handler.process_variant_records(nmd_genotype, nmd_no_mutationrecord)
    assert_equal 'Targeted BRCA mutation test', nmd_genotype.attribute_map['genetictestscope']
    assert_equal 1, nmd_genotype.attribute_map['teststatus']
    assert_nil nmd_genotype.attribute_map['gene']
  end
  ...
  test 'process_nilstatus_record_nogene_nomutation_targ' do
    ...
    # @handler.add_gene_info(nilstatus_genotype, nilstatus_no_mutationrecord)
    ...
    @handler.process_variant_records(nilstatus_genotype, nilstatus_no_mutationrecord)
    assert_equal 4, nilstatus_genotype.attribute_map['teststatus']
    assert_nil nilstatus_genotype.attribute_map['gene']
    assert_nil nilstatus_genotype.attribute_map['codingdnasequencechange']
  end
  ...
  test 'process_nilstatus_record_nogene_nomutation_noscope' do
    ...
    assert_equal 4, nostatus_genotype.attribute_map['teststatus']
  ...
  test 'process_noscope_with_gene_mutation' do
    ...
    @handler.process_variant_records(noscope_genotype, noscope_genemutation_record)
    assert_equal 'Unable to assign BRCA genetictestscope', noscope_genotype.attribute_map['genetictestscope']
    assert_equal 2, noscope_genotype.attribute_map['teststatus']
    assert_equal 8, noscope_genotype.attribute_map['gene']
    assert_equal 'c.8850G>T', noscope_genotype.attribute_map['codingdnasequencechange']
  end
  ...
  test 'process_non_brca_gene' do
    ...
    assert_equal 'c.3048del', genotypes[0].attribute_map['codingdnasequencechange']
    assert_equal 'p.Phe1016fs', genotypes[0].attribute_map['proteinimpact']
  end
  ...
  test 'process_fs_rec_with_gene_nomutation' do
    ...
    assert_equal 7, genotypes[0].attribute_map['gene']
    assert_equal 8, genotypes[1].attribute_map['gene']
    assert_nil nmd_withmutation_genotype.attribute_map['codingdnasequencechange']
    assert_nil nmd_withmutation_genotype.attribute_map['proteinimpact']
    # assert_equal 1, genotypes[0].attribute_map['teststatus']
  end
  ...
  test 'process_fs_rec_only_with_completed_status' do
    ...
    assert_equal 'Full screen BRCA1 and BRCA2', genotypes[0].attribute_map['genetictestscope']
    assert_equal 'Full screen BRCA1 and BRCA2', genotypes[1].attribute_map['genetictestscope']
    # assert_equal 4, completed_fs_genotype.attribute_map['teststatus']
    assert_equal 7, genotypes[0].attribute_map['gene']
    assert_equal 8, genotypes[1].attribute_map['gene']
  ...
  test 'process_targ_rec_with_gene_low_status' do
    ...
    @handler.process_variant_records(low_gene_genotype, low_gene_targ_rec)
    # assert_equal 4, low_gene_genotype.attribute_map['teststatus']
    assert_equal 8, low_gene_genotype.attribute_map['gene']
    assert_nil low_gene_genotype.attribute_map['codingdnasequencechange']
  end
  ...
  test 'process_targ_all_nils' do
    ...
    @handler.process_variant_records(all_nils_genotype, all_nils_targ_rec)
    assert_equal 4, all_nils_genotype.attribute_map['teststatus']
    assert_equal 7, all_nils_genotype.attribute_map['gene']
  ...
  test 'process_targ_rec_with_gene_verify_status' do
    ...
    @handler.process_variant_records(verify_gene_genotype, verify_gene_targ_rec)
    # assert_equal 4, verify_gene_genotype.attribute_map['teststatus']
    assert_equal 8, verify_gene_genotype.attribute_map['gene']
    assert_nil verify_gene_genotype.attribute_map['codingdnasequencechange']
  end
  ...
  test 'process_targ_rec_with_gene_no_result_status' do
    ...
    @handler.process_variant_records(no_result_gene_genotype, no_result_gene_targ_rec)
    # assert_equal 4, no_result_gene_genotype.attribute_map['teststatus']
    assert_equal 8, no_result_gene_genotype.attribute_map['gene']
    assert_nil no_result_gene_genotype.attribute_map['codingdnasequencechange']
  end
  ...
  test 'process_targ_rec_with_nilgene_completed_status' do
    ...
    @handler.process_variant_records(verify_nilgene_genotype, verify_nilgene_targ_rec)
    # assert_equal 4, verify_nilgene_genotype.attribute_map['teststatus']
    assert_nil verify_nilgene_genotype.attribute_map['gene']
    assert_nil verify_nilgene_genotype.attribute_map['codingdnasequencechange']
  end
