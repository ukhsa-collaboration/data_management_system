...
module Import
  module Colorectal
    module Core
      ...
      class ColorectalMainlineImporter < Import::Colorectal::Core::ColorectalBase
        ...
        def process_records(_klass, fields)
          ...
          if fields.size > 2
            @handler.process_and_correct_fields(Import::Brca::Core::RawRecord.new(fields))
          else
        ...
        def load
          ...
          @handler = Import::Colorectal::Core::ColorectalHandlerMapping.
